...
- 2 репозитория. 4 теста на работоспособность JPA-функциональности, применяя аннотацию @DataJpaTest
- 9 классов DTO. Проверялась сериализация и десериализация Json. Для тестовых классов применялась аннотация @JsonTest
## Как использовать
