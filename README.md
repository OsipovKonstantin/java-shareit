...
## Тестирование
Реализованы тесты разных уровней на:
- 9 классов DTO. Проверялась сериализация и десериализация Json. Аннотация для тестов - @JsonTest
- на 4 Service-класса. 67 юнит-тестов с использованием Mockito и Junit. 24 интеграционных теста с использованием аннотации @SpringBootTest
- 
## Как использовать
